...
const variantClasses: Record<ButtonVariant, string> = {
  primary: 'bg-indigo-600 hover:bg-indigo-500 text-white shadow-sm shadow-indigo-500/20 disabled:bg-indigo-300 dark:disabled:bg-indigo-800',
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'cursor-pointer disabled:cursor-not-allowed select-none active:scale-[0.99]',
